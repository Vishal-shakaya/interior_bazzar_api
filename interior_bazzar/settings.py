...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL')
    ...
    # Development:
    # eb deploy devLawcall --profile lawcall
    # http://devlawcall.eba-iw7xzgcp.ap-south-1.elasticbeanstalk.com/api/test_api/
    
    
    # Production
    # eb deploy  prodLawcall --profile lawcall
    # http://prodlawcall.eba-iw7xzgcp.ap-south-1.elasticbeanstalk.com/api/test_api/
